    ...
    <div className="bg-white py-4">
      <div className="grid gap-8 w-[95%] mx-auto">
        ...
        >
          ...
          <div className="flex bg-[rgba(0,0,0,0.2)] p-2 rounded-md col-span-2 gap-4 items-center justify-between">
            <div className="flex items-center gap-4">
              <Input name={"po_number"} label={"PO Number"} />
              <BiUserPlus
                className="bg-blue rounded-full cursor-pointer fill-white p-1"
                color="#fffff"
                size={35}
              />
            </div>
            <button
              type="button"
              className="p-2 px-6 bg-blue text-white rounded-md hover:opacity-90"
            >
              Edit
            </button>
          </div>
